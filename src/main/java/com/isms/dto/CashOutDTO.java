...
public class CashOutDTO {
	...
	public CashOutDTO(int id, Date recordDate, Double amount, String remarks, Clients clients, Personnels personnels) {
		super();
		this.id = id;
	...
	public CashOutDTO(Date recordDate, Double amount, String remarks, Clients clients, Personnels personnels) {
		super();
		this.recordDate = recordDate;
		this.amount = amount;
		this.remarks = remarks;
